...
% I. Setup the GA
ff='fs'; % objective function
npar=11; % number of optimization variables
...
% T = table(num2str(cost(1)), 'VariableNames', 'best cost' );
% Write data to text file
writematrix(num2str(cost(1)), 'MyFile.txt', 'WriteMode','append')
